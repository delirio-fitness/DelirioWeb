  ...
  return (
    <footer className="d3-footer">
      ...
      <div className="d3-footer-links">
        ...
        <FooterColumn sectionPrefix={sectionPrefix} title="Follow" links={[['Instagram', 'https://www.instagram.com/delirio.fitness/'], ['Iris', 'https://www.instagram.com/iris.from.delirio/'], ['Reed', 'https://www.instagram.com/reed.from.delirio.fit/'], ['TikTok', 'https://www.tiktok.com/@delirio__official']]} />
      </div>
